import { DifficultyLevel } from './quiz-generation.agent'

// ============================================
// GENERAL QUIZ GENERATION INSTRUCTIONS
// ============================================

export const GENERAL_QUIZ_REQUIREMENTS = `
...
export const ANSWER_VERIFICATION_INSTRUCTIONS = `
...
export const CODE_BASED_QUESTION_INSTRUCTIONS = `
...
export const FINAL_REMINDER_INSTRUCTIONS = `
...
export const EASY_QUIZ_INSTRUCTIONS = `
...
export const NORMAL_QUIZ_INSTRUCTIONS = `
...
export const HARD_QUIZ_INSTRUCTIONS = `
...
export function getQuizInstructions(difficulty: DifficultyLevel): string {
  switch (difficulty) {
    case 'easy':
